/*
 * Trivially modified from https://github.com/mfontanini/libtins
 *
...
struct conversion_dispatch_helper {
	...
	template<>
    static T dispatch<false>(T data) {
        return data;
    }
	template<>
    static T dispatch<true>(T data) {
 ...
 */ 
 ...
 inline T change_endian(T data) {
     return conversion_dispatcher<sizeof(T)>::dispatch<true>(data);
 }
